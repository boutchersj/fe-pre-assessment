...
function Password(props) {
  ...
  return (
    <Input>
      ...
      <input data-testid='password-field' name='password' onChange={props.handleChange} value={props.formInputValues.password} type={passwordType} autoComplete="on" autoFocus />
